    ...
    <section>
      <div className="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-black sm:text-4xl">HR roles and permissions</h1>
          <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-500">Manage HR Admin, Recruiter, HR Executive, Payroll Manager and custom access roles using least-privilege permissions without leaving HRMS.</p>
        </div>
