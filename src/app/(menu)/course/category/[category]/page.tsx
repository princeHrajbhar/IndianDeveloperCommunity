...
import { useGetCoursesQuery } from "@/src/features/course/api/courseApi";
...
const CourseCard = ({
  ...
  return (
    ...
    >
      <article className="flex h-full flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition-all duration-300 hover:border-[#22d3ee]/30 hover:shadow-xl">
        ...
        <div className="flex flex-1 flex-col p-4 sm:p-5">
          <span className="mb-1 truncate text-xs font-medium text-[#22d3ee]">
            {category}
          </span>

          <h3 className="mb-1.5 line-clamp-2 text-sm font-bold text-gray-900 transition-colors group-hover:text-[#22d3ee] sm:text-base">
            {course.title}
          </h3>
          ...
          <div className="mt-auto flex items-center justify-between gap-2">
            <div className="flex min-w-0 items-center gap-2">
              <span className="whitespace-nowrap text-base font-bold text-[#22d3ee] sm:text-lg">
                {formatPrice(
                  finalPrice,
                  course.currency || "INR",
                )}
            ...
            <span className="flex flex-shrink-0 items-center gap-1.5 rounded-xl bg-[#22d3ee] px-3 py-1.5 text-xs font-medium text-white transition-all hover:scale-105 hover:bg-[#0ea5e9] hover:shadow-lg hover:shadow-[#22d3ee]/25 sm:px-4 sm:py-2 sm:text-sm">
