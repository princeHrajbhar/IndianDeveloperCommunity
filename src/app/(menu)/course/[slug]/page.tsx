...
import TestimonialCarousel from "@/src/components/home/Testimonial";
import CourseSchema from "@/src/components/seo/CourseSchema";
...
const ToolChip = ({ tool }: { tool: ITool }) => (
  <div className="flex items-center gap-2.5 rounded-xl border border-gray-200 bg-white px-3.5 py-2.5">
    <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-[#22d3ee] to-[#6cb84d] text-sm font-bold text-white">
...
const SectionHeading = ({
  ...
  <div className="flex items-center gap-3">
    <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#22d3ee]/10">
...
export default function CourseDetailPage() {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-50">
        <div className="max-w-md px-4 text-center">
          ...
          <Link
            href="/course"
            className="inline-flex items-center gap-2 rounded-lg bg-[#22d3ee] px-6 py-2 text-white transition-colors hover:bg-[#015a9e]"
          >
    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-xl">
      <figure className="mb-5">
        <div className="relative aspect-[2/1] w-full overflow-hidden rounded-xl bg-gray-100">
          ...
          <img
            ...
            data-description={course.bannerImage?.description || undefined}
            className="absolute inset-0 h-full w-full object-cover"
          />
        </div>
        {course.bannerImage?.caption && (
      ...
      {purchaseUrl && canEnroll ? (
        <a
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#22d3ee] py-3 font-semibold text-white transition-all hover:bg-[#0ea5e9] hover:shadow-lg hover:shadow-[#22d3ee]/25"
        >
          {actionContent}
        </a>
      ) : (
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#22d3ee] py-3 font-semibold text-white transition-all hover:bg-[#0ea5e9] hover:shadow-lg hover:shadow-[#22d3ee]/25 disabled:cursor-not-allowed disabled:bg-gray-400 disabled:opacity-70"
        >
          {actionContent}
        </button>
      )}
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <CourseSchema slug={slug} course={course} imageUrl={bannerUrl} />
      <section className="bg-gradient-to-br from-[#22d3ee] via-[#0ea5e9] to-[#013b6b] text-white">
                  ...
                  {curriculum.map((section, index) => {
                    ...
                    return (
                      <div
                        ...
                        className="overflow-hidden rounded-xl border border-gray-200 transition-colors hover:border-[#22d3ee]/30"
                      >
                        <button
                          type="button"
                          onClick={() =>
                        ...
                        >
                          <div className="flex min-w-0 items-center gap-3">
                            {section.label && (
                              <span className="shrink-0 rounded-md bg-[#22d3ee]/10 px-2 py-0.5 text-xs font-semibold text-[#22d3ee]">
                                {section.label}
                              </span>
                            )}
                              ...
                              <div className="divide-y divide-gray-100 rounded-lg border border-gray-100">
                                {lessons.map(
                                  (lesson, lessonIndex) => (
                                    ...
                                    >
                                      <div className="flex min-w-0 items-center gap-3">
                                        <Video className="h-4 w-4 shrink-0 text-[#22d3ee]" />
                                        ...
                                        {lesson.isPreview && (
                                          <span className="shrink-0 rounded bg-[#22d3ee]/10 px-1.5 py-0.5 text-[10px] font-semibold text-[#22d3ee]">
                                            Preview
                                          </span>
                                        )}
                                      </div>
              ...
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                {resources.map((resource, index) => {
                  ...
                  return (
                    ...
                    >
                      <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#22d3ee]/10">
                        {isImage ? (
                      ...
                      {resourceUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          title={resource.file?.title || resource.name || undefined}
                          className="inline-flex shrink-0 items-center gap-1 rounded-lg bg-[#22d3ee] px-3 py-2 text-xs font-semibold text-white hover:bg-[#0ea5e9]"
                        >
              ...
              <div className="flex flex-wrap gap-3">
                {externalUrls.map((url, index) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 rounded-xl border border-gray-200 px-4 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:border-[#22d3ee]/40 hover:text-[#22d3ee]"
                  >
            ...
            <div className="space-y-3">
              {faqs.map((faq, index) => (
                <div
                  ...
                  className="overflow-hidden rounded-xl border border-gray-200 bg-white transition-colors hover:border-[#22d3ee]/30"
                >
                  <button
                    type="button"
                    onClick={() =>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 shadow-lg md:hidden">
        ...
        {purchaseUrl && canEnroll ? (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-[#22d3ee] to-[#6cb84d] px-6 py-2.5 font-semibold text-white transition-all hover:shadow-lg"
          >
            <ShoppingCart className="h-4 w-4" />
            Buy Now
          </a>
          ...
          <button
            ...
            onClick={handleEnrollNow}
            disabled={!canEnroll || isEnrolling}
            className="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-[#22d3ee] to-[#6cb84d] px-6 py-2.5 font-semibold text-white transition-all hover:shadow-lg disabled:cursor-not-allowed disabled:from-gray-400 disabled:to-gray-400"
          >
            {actionContent}
          </button>
        )}
