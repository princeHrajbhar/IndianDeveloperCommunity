  ...
  return (
    <>
      <section className="relative h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px] overflow-hidden bg-white">
            ...
            <div className="relative z-20 flex h-full items-center mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="max-w-2xl text-white">
                ...
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight">
                  {slide.title}
                  <span className="block bg-gradient-to-r from-[#22d3ee] to-[#6cb84d] bg-clip-text text-transparent">
                    {slide.highlight}
                  </span>
                </h1>
                ...
                <div className="mt-6 sm:mt-8 md:mt-10">
                  <button
                    ...
                    className="inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-[#22d3ee] to-[#6cb84d] px-4 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base font-semibold text-white shadow-lg transition-all hover:scale-105 hover:shadow-[#22d3ee]/25 w-full sm:w-auto"
                  >
                    Subscribe Now
                  </button>
                </div>
        ...
        <button
          onClick={prevSlide}
          className="hidden sm:flex absolute left-2 sm:left-4 top-1/2 z-30 -translate-y-1/2 rounded-full bg-white/20 p-1.5 sm:p-2 text-white backdrop-blur-md transition hover:bg-gradient-to-r hover:from-[#22d3ee] hover:to-[#6cb84d] hover:text-white"
        ...
        <button
          onClick={nextSlide}
          className="hidden sm:flex absolute right-2 sm:right-4 top-1/2 z-30 -translate-y-1/2 rounded-full bg-white/20 p-1.5 sm:p-2 text-white backdrop-blur-md transition hover:bg-gradient-to-r hover:from-[#22d3ee] hover:to-[#6cb84d] hover:text-white"
          ...
          {slides.map((_, index) => (
            <button
              ...
              className={`h-1.5 sm:h-2 rounded-full transition-all ${
                current === index
                  ? 'w-4 sm:w-6 md:w-8 bg-gradient-to-r from-[#22d3ee] to-[#6cb84d]'
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center px-3 sm:px-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl max-w-sm sm:max-w-md w-full p-5 sm:p-6 md:p-8 animate-in fade-in zoom-in duration-300 max-h-[90vh] overflow-y-auto">
            ...
            <div className="text-center mb-4 sm:mb-6">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-[#22d3ee] to-[#6cb84d] rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
              ...
              <form onSubmit={handleSubscribe} className="space-y-3 sm:space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#22d3ee] focus:border-transparent transition-all text-gray-900 placeholder-gray-400 text-sm sm:text-base"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full py-2.5 sm:py-3 bg-gradient-to-r from-[#22d3ee] to-[#6cb84d] text-white font-semibold rounded-lg transition-all hover:shadow-lg hover:shadow-[#22d3ee]/25 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center text-sm sm:text-base"
                >
                  {isSubmitting ? (
                    <>
