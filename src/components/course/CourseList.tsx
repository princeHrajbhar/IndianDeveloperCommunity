...
const CourseCard: React.FC<{
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 h-full border border-gray-100 hover:border-[#22d3ee]/30 flex flex-col">
        {/* Image Container - Fixed aspect ratio with proper object fit */}
        <div className="relative w-full pt-[50%] flex-shrink-0 overflow-hidden">
          {course.bannerImage?.url ? (
            ...
            <div className="absolute inset-0 bg-[#22d3ee] flex items-center justify-center">
        ...
        <div className="p-4 sm:p-5 flex flex-col flex-1">
          {/* Category */}
          <span className="text-xs font-medium text-[#22d3ee] mb-1 truncate">
            {course.category}
          </span>

          <h3 className="text-sm sm:text-base font-bold text-gray-900 group-hover:text-[#22d3ee] transition-colors line-clamp-2 mb-1.5">
            {course.title}
          </h3>
          ...
          <div className="flex items-center justify-between gap-2 mt-auto">
            <div className="flex items-center gap-2 min-w-0">
              <span className="text-base sm:text-lg font-bold text-[#22d3ee] whitespace-nowrap">
            ...
            <span className="flex-shrink-0 px-3 sm:px-4 py-1.5 sm:py-2 bg-[#22d3ee] group-hover:bg-[#0ea5e9] group-hover:shadow-lg group-hover:shadow-[#22d3ee]/25 text-white rounded-xl text-xs sm:text-sm font-medium transition-all group-hover:scale-105 flex items-center gap-1.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white rounded-2xl overflow-hidden shadow-sm animate-pulse">
                <div className="w-full pt-[50%] bg-gray-200"></div>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="text-center max-w-md">
          ...
          <button
            ...
            className="px-6 py-3 bg-[#22d3ee] text-white rounded-xl hover:bg-[#0ea5e9] hover:shadow-lg hover:shadow-[#22d3ee]/25 transition-all font-medium"
          >
            Retry
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gray-50 py-4 sm:py-8">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-2xl mx-auto mb-6 sm:mb-8">
          <div className="relative flex items-center bg-white border border-gray-200 rounded-2xl shadow-sm focus-within:ring-2 focus-within:ring-[#22d3ee] focus-within:border-transparent transition-all">
        ...
        {isSearching && searchResults.length > 0 && (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6 mb-6 sm:mb-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 gap-2">
              ...
              <button
                onClick={clearSearch}
                className="text-sm text-gray-500 hover:text-[#22d3ee] transition-colors"
              >
                Clear Search
              </button>
            </div>
        ...
        {isSearching && searchResults.length === 0 && (
          <div className="text-center bg-white rounded-2xl shadow-sm border border-gray-200 p-8 sm:p-12 mb-6 sm:mb-8">
            ...
            <button
              onClick={clearSearch}
              className="px-6 py-2 bg-[#22d3ee] text-white rounded-lg hover:bg-[#0ea5e9] hover:shadow-lg hover:shadow-[#22d3ee]/25 transition-all"
            >
              Clear Search
            </button>
          </div>
              ...
              >
                ...
                <div className="relative group">
                  ...
                  <button
                    ...
                    className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg rounded-full p-1.5 sm:p-2.5 border border-gray-200 text-gray-700 hover:bg-[#22d3ee] hover:text-white transition-all -translate-x-2 sm:-translate-x-4 opacity-0 group-hover:opacity-100 focus:opacity-100 hidden sm:block"
                  >
                  ...
                  <button
                    ...
                    className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg rounded-full p-1.5 sm:p-2.5 border border-gray-200 text-gray-700 hover:bg-[#22d3ee] hover:text-white transition-all translate-x-2 sm:translate-x-4 opacity-0 group-hover:opacity-100 focus:opacity-100 hidden sm:block"
                  >
