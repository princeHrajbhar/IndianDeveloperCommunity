  ...
  return (
    <>
      <section className="relative h-[500px] sm:h-[450px] md:h-[400px] overflow-hidden bg-white">
              ...
              <div className="max-w-2xl text-white">
                ...
                <div className="mt-6 sm:mt-10">
                  <button
                    ...
                    className="inline-flex items-center justify-center rounded-lg bg-[#22d3ee] px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base font-semibold text-white shadow-lg transition-all hover:bg-[#0ea5e9] hover:scale-105 hover:shadow-[#22d3ee]/25"
                  >
                    Get Started Now
                  </button>
                </div>
        ...
        <button
          onClick={prevSlide}
          className="absolute left-2 sm:left-4 top-1/2 z-30 -translate-y-1/2 rounded-full bg-white/20 p-1.5 sm:p-2 text-white backdrop-blur-md transition hover:bg-[#22d3ee] hover:text-white"
        >
        ...
        <button
          onClick={nextSlide}
          className="absolute right-2 sm:right-4 top-1/2 z-30 -translate-y-1/2 rounded-full bg-white/20 p-1.5 sm:p-2 text-white backdrop-blur-md transition hover:bg-[#22d3ee] hover:text-white"
        >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#22d3ee] focus:border-transparent outline-none transition text-sm"
                ...
                <button
                  ...
                  className="w-full py-3 bg-[#22d3ee] text-white font-semibold rounded-lg transition-all hover:bg-[#0ea5e9] hover:scale-[1.02] hover:shadow-lg disabled:opacity-70 disabled:cursor-not-allowed text-sm sm:text-base"
                >
                  {isSubmitting ? (
