...
import { useCourseCategory } from '@/src/features/courseCategory/hooks/useCourseCategory';
import { useGetProfileQuery } from '@/src/lib/features/profiles/profile-api';
import StringListEditor from '@/src/components/dashboard/course/StringListEditor';
import CurriculumBuilder from '@/src/components/dashboard/course/CurriculumBuilder';
import type {
  IHighlight,
  ITool,
  ICurriculumSection,
  ...
  ITestimonial,
  CourseLevel,
} from '@/src/features/course/api/courseApi';
...
const getUploadedFileSeo = (file?: UploadedFile): MediaSeoValue => ({
  title: file?.title || '',
...
const CourseForm: React.FC<CourseFormProps> = ({
  ...
  const profileName = profileResponse?.data.fullName?.trim() || '';
  ...
  const [bannerSeo, setBannerSeo] = useState<MediaSeoValue>(getUploadedFileSeo());
  ...
  useEffect(() => {
    if (initialData) {
      setFormData((prev) => ({
        ...
        resources: (initialData.resources ?? []).map((resource) => ({
          ...
          file: {
            ...
            ...getUploadedFileSeo(resource.file),
          },
        })),
      ...
      if (initialData.bannerImage?.url) {
        ...
        setBannerSeo(getUploadedFileSeo(initialData.bannerImage));
      } else {
        setBannerSeo(getUploadedFileSeo());
      }
      if (initialData.slug) {
  ...
  useEffect(() => {
    ...
    setFormData((previous) =>
      previous.publishedBy
        ? previous
        : { ...previous, publishedBy: profileName },
    );
  }, [profileName]);
  ...
  "shortDescription": "Learn frontend, backend, databases, APIs, deployment, and modern development workflows by building production-ready projects.",
  "price": 24999,
  "discountedPrice": 14999,
  "purchaseUrl": "https://example.com/checkout/full-stack-web-development",
  "metaTitle": "Full Stack Web Development Bootcamp | Learn React and Node.js",
  "metaDescription": "Become a job-ready full stack developer by learning HTML, CSS, JavaScript, React, Node.js, Express, MongoDB, APIs, Git, testing, and deployment.",
  "keywords": [
  ...
  "cms": "<h2>About This Course</h2>\\n<p>This practical bootcamp takes you from web fundamentals to building and deploying complete full stack applications.</p>\\n\\n<h3>What You Will Build</h3>\\n<ul>\\n  <li>A responsive business website</li>\\n  <li>A task management application</li>\\n  <li>A secure REST API</li>\\n  <li>A complete e-commerce application</li>\\n</ul>\\n\\n<h3>Learning Approach</h3>\\n<p>Every module combines clear explanations, guided coding sessions, exercises, assignments, and project-based learning.</p>\\n\\n<table>\\n  <thead>\\n    <tr>\\n      <th>Area</th>\\n      <th>Technologies</th>\\n    </tr>\\n  </thead>\\n  <tbody>\\n    <tr>\\n      <td>Frontend</td>\\n      <td>HTML, CSS, JavaScript, React</td>\\n    </tr>\\n    <tr>\\n      <td>Backend</td>\\n      <td>Node.js, Express, REST APIs</td>\\n    </tr>\\n    <tr>\\n      <td>Database</td>\\n      <td>MongoDB and Mongoose</td>\\n    </tr>\\n    <tr>\\n      <td>Deployment</td>\\n      <td>Vercel, Render, and cloud databases</td>\\n    </tr>\\n  </tbody>\\n</table>",
  "heroHeadline": "Become a Job-Ready Full Stack Developer",
  "highlights": [
    {
      "label": "Duration",
      "value": "16 Weeks"
    ...
    {
      "label": "Projects",
      "value": "4 Real Projects"
    },
    {
      "label": "Sessions",
      "value": "48 Live Classes"
    },
    {
      "label": "Support",
      "value": "Mentor Assistance"
    }
  ],
  "whatYouWillLearn": [
    "Build responsive websites using semantic HTML and modern CSS",
    ...
    "Test, debug, optimize, and deploy full stack applications"
  ],
  "requirements": [
    ...
    "Ability to dedicate at least 8 hours per week"
  ],
  "whoIsThisFor": [
    "Students preparing for software development careers",
    "Working professionals changing careers",
    "Freelancers who want to build complete client applications",
    "Entrepreneurs who want to develop product prototypes",
    "Frontend developers who want to learn backend development"
  ],
  "notFor": [
    "Learners looking only for theoretical lectures",
    "People unable to complete weekly coding assignments",
    "Experienced senior full stack developers"
  ],
  "tools": [
    {
  ...
  "curriculum": [
    {
      ...
      "description": "Understand how websites work and build responsive page layouts.",
      "lessons": [
        {
          "title": "How the Web Works",
          "description": "Browsers, servers, HTTP, domains, and hosting.",
          "duration": "45 minutes"
        },
        {
          "title": "HTML Fundamentals",
          "description": "Semantic markup, forms, tables, media, and accessibility.",
          "duration": "2 hours"
        },
        {
          "title": "CSS and Responsive Design",
          "description": "Flexbox, Grid, responsive layouts, and reusable styling.",
          "duration": "3 hours"
        }
      ]
    },
    {
      ...
      "description": "Learn JavaScript fundamentals and browser programming.",
      "lessons": [
        {
          "title": "JavaScript Essentials",
          "description": "Variables, functions, arrays, objects, loops, and conditions.",
          "duration": "3 hours"
        },
        {
          "title": "DOM and Events",
          "description": "Create interactive user interfaces using browser APIs.",
          "duration": "2 hours"
        },
        {
    ...
    },
    {
      ...
      "description": "Build component-based applications using React.",
      "lessons": [
        {
        ...
        },
        {
          ...
          "description": "Manage local state and side effects with React hooks.",
          "duration": "3 hours"
        },
        {
          "title": "Routing and Forms",
          "description": "Create multi-page experiences and validated forms.",
          "duration": "2 hours"
        }
      ]
    },
    {
      ...
      "description": "Create secure and scalable APIs with Node.js and Express.",
      "lessons": [
        {
          "title": "Node.js and Express",
          "description": "Set up servers, routes, controllers, and middleware.",
          "duration": "3 hours"
        },
        {
          "title": "MongoDB and Mongoose",
          "description": "Model, store, query, and update application data.",
          "duration": "3 hours"
        },
        {
          "title": "Authentication",
          "description": "Implement registration, login, JWT, and protected routes.",
          "duration": "3 hours"
        }
      ]
    },
    {
      ...
      "description": "Prepare and deploy a complete full stack application.",
      "lessons": [
        {
          "title": "Testing and Debugging",
          "description": "Test APIs and troubleshoot frontend and backend issues.",
          "duration": "2 hours"
        },
        {
          "title": "Performance and Security",
          "description": "Apply practical optimization and security best practices.",
          "duration": "2 hours"
        },
        {
  ...
  "projects": [
    {
      ...
      "description": "Build a responsive multi-page website using semantic HTML, CSS Grid, Flexbox, and JavaScript."
    },
    {
      "title": "React Task Manager",
      "description": "Create a React task management application with reusable components, filters, forms, and local persistence."
    },
    {
      "title": "Secure REST API",
      "description": "Build a Node.js and Express API with MongoDB, validation, authentication, authorization, and error handling."
    },
    {
      "title": "Full Stack E-commerce Platform",
      "description": "Develop and deploy an online store with products, cart, authentication, checkout flow, and an admin dashboard."
    }
  ],
  "certificate": {
    "description": "Receive a verified course completion certificate demonstrating practical full stack development skills.",
    "requirements": [
      "Attend at least 80% of live sessions",
      "Complete all required assignments",
      "Submit all four course projects",
      "Pass the final assessment with at least 70%"
    ]
  },
  "careerRoles": [
  ...
  "testimonials": [
    {
      ...
      "company": "Dummy Tech Labs",
      "content": "The projects helped me understand how frontend, backend, and databases work together. I used the final project in my job portfolio.",
      "rating": 5
    },
    {
      "name": "Meera Patel",
      ...
      "content": "The course structure was practical and easy to follow. The mentor feedback helped me improve my code quality and confidence.",
      "rating": 5
    }
  ],
  "language": "English",
  "durationWeeks": 16,
  "format": "Live online cohort with recordings",
  "faqs": [
    {
      "question": "Do I need previous coding experience?",
      "answer": "No. The course starts with web development fundamentals and gradually progresses to advanced full stack topics."
    },
    {
      "question": "Will these FAQs replace existing FAQs?",
      "answer": "No. The complete course JSON importer should append these FAQs to the FAQs already present in the form."
    },
    {
      "question": "Are class recordings included?",
      "answer": "Yes. Recordings are available for enrolled learners after each live session."
    },
    {
      "question": "Will I receive a certificate?",
      "answer": "Yes. Learners who meet the attendance, assignment, project, and assessment requirements receive a completion certificate."
    }
  ]
}`;
  ...
  const updateResourceSeo = (index: number, next: MediaSeoValue) => {
    setFormData((previous) => ({
      ...previous,
      resources: previous.resources.map((resource, resourceIndex) =>
        resourceIndex === index
          ? { ...resource, file: { ...resource.file, ...next } }
          : resource,
      ),
    }));
  };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const resourceMetadata = [...retainedResources, ...pendingResources].map(
      (resource) => ({
        ...
        type: resource.type,
        file: {
          ...(isPersistedResource(resource) && resource.file.storageKey
            ? { storageKey: resource.file.storageKey }
            : {}),
          ...(isPersistedResource(resource) && resource.file.url
            ? { url: resource.file.url }
            : {}),
          ...getUploadedFileSeo(resource.file),
        },
    ...
    if (!removeBanner && (bannerFile || initialData?.bannerImage)) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid min-w-0 gap-6 xl:grid-cols-[250px_minmax(0,1fr)]">
        ...
        <aside className="self-start xl:sticky xl:top-0">
          <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
            <p className="px-2 pb-3 text-xs font-semibold uppercase tracking-wider text-gray-500">
              Course sections
            </p>
            <button
              type="button"
              ...
              className="mb-3 flex w-full items-center gap-2 rounded-xl bg-blue-600 px-4 py-3 text-left text-sm font-medium text-white transition-all hover:bg-blue-700"
            >
              <FileJson className="h-4 w-4 shrink-0" />
              Import Course JSON
            </button>

            <nav className="max-h-[calc(100vh-260px)] space-y-1 overflow-y-auto overscroll-contain pr-1">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleInputChange}
                maxLength={160}
                placeholder="Public publisher name"
                className="w-full rounded-xl border border-gray-300 bg-white py-2.5 pl-10 pr-4 text-sm focus:border-transparent focus:outline-none focus:ring-2 focus:ring-teal-500"
              />
            </div>
            <p className="mt-1 text-xs text-gray-400">
              {profileLoading
                ? 'Loading your profile name…'
                : profileName
                  ? `Auto-filled from your profile as: ${profileName}. You can edit it.`
                  : 'Enter the public publisher name.'}
            </p>
          </div>
      ...
      >
        ...
        <div className="mt-5">
          ...
          <input
            ...
            onChange={handleInputChange}
            placeholder="https://www.quantumfinix.com/checkout/..."
            className="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent text-sm"
          />
          <p className="text-xs text-gray-400 mt-1">
      ...
      >
        ...
        <div className="mb-6">
          ...
          {!removeBanner && (bannerFile || initialData?.bannerImage) && (
            <MediaSeoFields
              value={bannerSeo}
                ...
                <div key={index} className="rounded-xl border border-gray-200 bg-gray-50 p-3">
                  <div className="flex items-center gap-3">
                    ...
                    <input
                      ...
                      className="flex-1 rounded-lg border border-gray-300 px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500"
                    />
                    <select
                      value={resource.type}
                      onChange={(e) => updateResource(index, 'type', e.target.value as 'pdf' | 'image')}
                      className="rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500"
                    >
                  ...
                  <MediaSeoFields
                    value={getUploadedFileSeo(resource.file)}
                    onChange={(next) => updateResourceSeo(index, next)}
                    compact
                  />
                </div>
              ))}
