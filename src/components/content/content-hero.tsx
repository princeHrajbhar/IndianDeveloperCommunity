  ...
  return (
    <section className="relative overflow-hidden border-b border-white/10 bg-[#020711] px-5 py-20 sm:px-8 lg:py-28">
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mt-8 flex flex-wrap gap-3"><Link href="/blog" className="rounded-full border border-white/10 bg-white/[0.04] px-6 py-3 text-sm font-bold text-white">Read the blog</Link></div>
      </div>
    </section>
  );
}
