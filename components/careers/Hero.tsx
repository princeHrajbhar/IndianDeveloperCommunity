    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="flex-1">
          ...
          <p className="text-gray-400 mt-1">{department}</p>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:border-cyan-400/30 transition-all">
        <div className="w-16 h-16 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 mb-4 flex items-center justify-center text-2xl font-bold text-white">
          {name.charAt(0)}
        </div>
    ...
    >
      ...
      <div className="relative bg-[#0a0c15] border border-white/10 rounded-2xl p-8 hover:border-transparent transition-all">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-500/10 rounded-full">
          ...
          <span className="text-sm text-cyan-400">{impact}</span>
        </div>
      </div>
    </motion.div>
  )
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex items-center justify-center px-6">
          <div className="max-w-6xl mx-auto text-center">
            <motion.div
              ...
              className="mb-8"
            >
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-sm font-mono">
            ...
            <motion.h1 
              ...
              className="text-6xl md:text-5xl font-black mb-8"
            >
            ...
            >
              <button className="group px-8 py-4 rounded-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold flex items-center gap-2 hover:shadow-lg hover:shadow-cyan-500/30 transition-all">
                View Open Roles
                <HiOutlineArrowLongRight className="w-4 h-4 group-hover:translate-x-1 transition" />
              </button>
              <button className="px-8 py-4 rounded-full border border-white/20 text-white font-semibold hover:bg-white/5 transition-all">
                Meet the Team
              </button>
            </motion.div>
          </div>
        ...
        <section className="py-32 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <button className="text-cyan-400 hover:text-fuchsia-400 transition-colors flex items-center gap-2 mx-auto">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-16">
                ...
                <button className="group px-10 py-5 rounded-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold text-lg hover:shadow-lg hover:shadow-cyan-500/30 transition-all">
