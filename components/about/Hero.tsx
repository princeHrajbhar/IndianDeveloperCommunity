  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:border-cyan-500/30 transition-all">
        ...
        <div className="text-sm font-mono font-semibold text-white mb-1">{title}</div>
  ...
  return (
    <section ref={containerRef} className="relative bg-[#03050b] text-white min-h-screen overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 pt-32 pb-24">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 backdrop-blur-sm">
            ...
            />
            <span className="text-sm font-mono text-cyan-400 tracking-wider">AI PRODUCT DEVELOPER • INNOVATION LAB</span>
            <motion.span
              animate={{ rotate: -360 }}
              transition={{ duration: 4, repeat: Infinity, ease: "linear" }}
        ...
        >
          <h1 className="text-6xl md:text-5xl font-black mb-6 font-mono">
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <motion.div
                      ...
                      className="flex items-center gap-3 group font-mono"
                    >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group mt-8 inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold relative overflow-hidden font-mono"
                >
      ...
      <motion.div 
        ...
        className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-xs font-mono text-gray-500"
      >
